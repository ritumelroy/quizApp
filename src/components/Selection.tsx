...
function Selection() {
  ...
  return (
    <>
      <Switch switchStyle="switch-padding" />
      <div className="selection-section">
        <section className="section-left">
          <h1 id="SectionDark" className="section-h ">
            Welcome to the <span>Frontend Quiz!</span>
          </h1>
          <p id="SectionP" className="select-p ">
        ...
        <section className="selection-btns">
          ...
          >
            ...
            <span className="btn-span">HTML</span>
          </button>
          ...
          >
            ...
            <span className="btn-span">CSS</span>
          </button>
          ...
          >
            ...
            <span className="btn-span">Javascript</span>
          </button>
          ...
          >
            ...
            <span className="btn-span">Accessibility</span>
          </button>
        </section>
      </div>
    </>
